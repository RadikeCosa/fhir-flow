  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <p className="max-w-md text-sm leading-6">
        Proyecto de aprendizaje sobre interoperabilidad en salud: Implementación
        de un cliente web para la gestión de pacientes bajo el estándar FHIR R4,
        conectado a un servidor local HAPI mediante Docker
      </p>
      <Link
        href="/patients"
